...
function NewWordExercises({ newWordsCount }: NewWordExercisesProps) {
  return (
    <div
      className={`${newWordsCount >= 5 ? "xs:justify-evenly justify-around lg:justify-around lg:px-10 lg:py-6 2xl:justify-evenly" : "justify-center"} rounded-main-blocks shadow-main-blocks flex min-h-0 w-full flex-col overflow-y-auto bg-white p-5`}
    >
      {newWordsCount >= 5 ? (
        <>
        ...
        <>
          <div className="mb-5 sm:mb-7">
            ...
            <p className="xs:text-xl text-center text-lg text-gray-800 sm:text-2xl md:text-[26px] lg:text-2xl 2xl:text-[26px]">
              ...
              мінімум{" "}
              <span className="font-bold text-blue-800">5 незнайомих</span> слів
            </p>
          </div>
