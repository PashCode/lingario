...
import ExercisesSkeleton from "@/features/exercises/components/exercises/overview/ExercisesSkeleton";
...
function RepeatWordExercises({
  repeatWordsCount,
  isPersonalDictLoading,
}: RepeatWordExercisesProps) {
  return (
    <>
      {isPersonalDictLoading ? (
        <ExercisesSkeleton />
        ...
        <div
          className={`${repeatWordsCount >= 5 ? "justify-around sm:justify-evenly lg:justify-around lg:px-9.5 lg:py-6 2xl:justify-evenly" : "justify-center"} animate-fade-in rounded-main-blocks shadow-main-blocks flex min-h-0 w-full flex-col overflow-y-auto bg-white p-5`}
        >
          {repeatWordsCount >= 5 ? (
            <>
              ...
              <div className="flex items-center justify-between">
                ...
                <img
                  src={repeatWordsImg}
                  alt="repeat-words"
                  className="2xl: 2xl:w-55h hidden h-45 w-45 lg:block 2xl:h-55"
                />
              </div>
