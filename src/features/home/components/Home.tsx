...
export function Home() {
  const { personalDictionary } = useExercisesWords();
  ...
  return (
    <section className="grid h-full w-full min-w-0 grid-rows-[auto_minmax(0,1fr)] items-center justify-items-center">
      <div className="rounded-main-blocks shadow-main-blocks xs:min-h-25 flex min-h-20 w-full justify-between bg-blue-800 px-7.5 py-3 text-white 2xl:min-h-30">
        <div className="xs:text-2xl flex flex-col gap-y-1 text-lg 2xl:text-3xl">
          <LuQuote
