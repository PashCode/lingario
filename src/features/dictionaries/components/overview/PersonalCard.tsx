...
function PersonalCard({ personalDictionary }: PersonalCardProps) {
  return (
    <div
      className={`${!personalDictionary.length ? "justify-center" : "justify-around sm:justify-evenly lg:justify-around lg:px-10 lg:py-6"} rounded-main-blocks shadow-main-blocks flex min-h-0 w-full flex-col overflow-y-auto bg-white p-5`}
    >
      {personalDictionary.length ? (
        ...
        <>
          <div className="mb-5 sm:mb-7">
            <h1 className="xs:text-3xl mb-1 text-center text-2xl font-bold sm:mb-2 sm:text-4xl md:text-[40px] lg:text-4xl 2xl:text-[40px]">
            ...
            <p className="xs:text-xl text-center text-lg text-gray-800 sm:text-2xl md:text-[26px] lg:text-2xl 2xl:text-[26px]">
              Після цього відкриється <br /> персональний словник
            </p>
          </div>
