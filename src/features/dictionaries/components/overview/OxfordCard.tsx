...
import DictionaryCardSkeleton
  from "@/features/dictionaries/components/overview/DictionaryCardSkeleton";
  ...
  return (
    <>
      {isAvailableWordsLoading ? (
        ...
        <div className="rounded-main-blocks shadow-main-blocks animate-fade-in flex min-h-0 w-full flex-col justify-around overflow-y-auto bg-white p-5 sm:justify-evenly lg:justify-around lg:px-10 lg:py-6 2xl:justify-evenly">
